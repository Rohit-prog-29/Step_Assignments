# Week 5 - Assignment Problems (Category C Tiered)

This directory contains the Java implementations for **Week 5 Assignment Problems**.
...
```cmd
javac week_5/assignment_problems/*.java

java -cp week_5/assignment_problems Problem1_FantasyTeamMultiplier
java -cp week_5/assignment_problems Problem2_DuplicatePlayerPick
java -cp week_5/assignment_problems Problem3_TopPerformerTracker
java -cp week_5/assignment_problems Problem4_MatchDayGridAnalyzer
java -cp week_5/assignment_problems Problem5_FantasyLeagueAutoDraft
```
