# Week 5 - Practice Problems (Category C Tiered)

This directory contains the Java implementations for **Week 5 Practice Problems**.
...
```cmd
javac week_5/practice_problems/*.java

java -cp week_5/practice_problems Problem1_HackathonScoreCurveBooster
java -cp week_5/practice_problems Problem2_DuplicateTeamNameFinder
java -cp week_5/practice_problems Problem3_TopThreePodiumFinder
java -cp week_5/practice_problems Problem4_HackathonSeatingGridOptimizer
java -cp week_5/practice_problems Problem5_PlacementDriveShortlisting
```
