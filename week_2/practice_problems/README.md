# Week 2 - Practice Problems (Category C)

This directory contains the Java implementations for **Week 2 Practice Problems (LeetCode Category C)**.
...
```cmd
javac week_2/practice_problems/*.java

java -cp week_2/practice_problems Problem1_TwoSum
java -cp week_2/practice_problems Problem2_BestTimeToBuyAndSellStock
java -cp week_2/practice_problems Problem3_ContainsDuplicate
java -cp week_2/practice_problems Problem4_MergeTwoSortedArrays
java -cp week_2/practice_problems Problem5_RotateArray
```
