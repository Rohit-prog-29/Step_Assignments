# Week 2 - Assignment Problems (Category C)

This directory contains the Java implementations for **Week 2 Assignment Problems (LeetCode Category C)**.
...
```cmd
javac week_2/assignment_problems/*.java

java -cp week_2/assignment_problems Problem1_ProductExceptSelf
java -cp week_2/assignment_problems Problem2_MaximumSubarray
java -cp week_2/assignment_problems Problem3_ThreeSum
java -cp week_2/assignment_problems Problem4_SubarraySumEqualsK
java -cp week_2/assignment_problems Problem5_FindMinInRotatedSortedArray
```
